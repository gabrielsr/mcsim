...
from .helpers import rotate_around_point
from mcsim.core import Component
...
class Position(Component):
    ...
    def _get_box(self):
        ...
        if self.angle != 0:
            points = map(lambda x: rotate_around_point(x, math.radians( -self.angle), center), points)
        return points